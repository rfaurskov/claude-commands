...
{
  "continue": true,
  "additionalContext": "TOBEFIX TRIGGERED: The user mentioned 'tobefix'. Extract the task/issue they described and add it to /home/user/queens-game/TOBEFIX.md. Format: add a new bullet point under the appropriate section (or create a section if needed). Include today's date. After adding, briefly confirm what was logged."
}
EOF
else
  echo '{"continue": true}'
